  ...
  return (
    <>
      <PageHeader
        ...
        title="Code editor"
        description="The Monaco editor with Unity autocomplete. Try typing 'transform.', 'Debug.', or 'Vector3.' to see suggestions. Work auto-saves locally."
        action={
        ...
        <div className="space-y-4">
          ...
          <Card className="bg-cream-100 border-wood-200">
            ...
            <ul className="text-xs text-wood-700 space-y-1.5 list-disc list-inside marker:text-wood-400">
              <li>
                Type <code className="text-terracotta-700">transform.</code> for
                Transform members
              </li>
              <li>
              ...
              <li>
                Type <code className="text-terracotta-700">Start</code> for the
                lifecycle snippet
              </li>
